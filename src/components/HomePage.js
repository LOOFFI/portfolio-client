...
isOpen(e) {
  ...
  render() {
    ...
    const {image1, image2, image3, image4, image5, image6, image7, height, navbarOpen} = this.state;
          ...
          <div className="container">
            ...
            <div>
              <ul className="card-container">
                <Card backgroundImage={image2} title={'titre'}></Card>
                <Card backgroundImage={image1} title={'titre'}></Card>
                <Card backgroundImage={image6} title={'titre'}></Card>
                <Card backgroundImage={image5} title={'titre'}></Card>
                <Card backgroundImage={image3} title={'titre'}></Card>
                <Card backgroundImage={image4} title={'titre'}></Card>
                <Card backgroundImage={image2} title={'titre'}></Card>
                <Card backgroundImage={image6} title={'titre'}></Card>
              </ul>
            </div>
            ...
            <span onClick={() => this.scrollTo('third-title')}>
              <div style={{height}}>
                <div style={insideStyles}>
                    <h1>Cliquez sur ce texte à effet</h1>
                </div>
